<section class="p-4 pb-20 space-y-4 overflow-y-auto">
	...
	<p class="font-bold pl-4 text-2xl">Improvements</p>
	<nav class="list-nav">
		<ul>
			<li>
	...
	<hr class="!my-6 opacity-50" />
	<p class="font-bold pl-4 text-2xl">Gas savings</p>
	<nav class="list-nav">
		<ul>
			<li>
				<a href="/documentation"><span class="flex-auto">Infinity approve</span> </a>
			</li>
			<li>
				<a href="/documentation"><span class="flex-auto">Balances slots</span> </a>
			</li>
			<li>
				<a href="/documentation"><span class="flex-auto">Contributing</span> </a>
			</li>
		</ul>
	</nav>
	<hr class="!my-6 opacity-50" />
	<p class="font-bold pl-4 text-2xl">Security</p>
	<nav class="list-nav">
		<ul>
			<li>
